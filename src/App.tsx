              ...
              <div className="mt-3 flex items-center gap-2">
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    className="w-full h-10 pl-9 pr-3 rounded-2xl bg-zinc-100/80 border border-zinc-200/60 text-[14px] placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-violet-300"
                  />
                </div>
